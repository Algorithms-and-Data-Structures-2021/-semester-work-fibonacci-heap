...
https://github.com/Algorithms-and-Data-Structures-2021/semester-work-fibonacci-heap-AEA/tree/main/dataset
...
**добавлению** элементов в структуру данных. Названия файлов `100-n.txt`. `5000000-n.txt`, где n - номер тестового набора, и т.д. хранят информацию о размере набора данных (т.е. количество элементов). 
